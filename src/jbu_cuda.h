...
// WMF-specific dilation: nearest-neighbour boundary shift.
// Scans outward per pixel for the nearest qualifying foreground
// neighbour and adopts its actual value, shifting the detected
// edge boundary by ~radius pixels without blending in unrelated
